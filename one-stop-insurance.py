...
while True:
    ...
    while True:
        ...
        if (
            check_post_code
            == "Data Entry Error (Invalid postal code) - Postal code must be 6 characters long. Please try again."
            or check_post_code
            == "Data Entry Error (Invalid postal code) - Postal code must have letters in the first, third, and fifth positions. Please try again."
            or check_post_code
            == "Data Entry Error (Invalid postal code) - Postal code must have digits in the second, fourth, and sixth positions. Please try again."
        ):
            print()
    ...
    while True:
        ...
        if (
            check_phone_num
            == "Data Entry Error (Invalid phone number) - Character count issue. Please try again."
            or check_phone_num
            == "Data Entry Error (Invalid phone number) - Phone number must only be numerical values. Please try again."
        ):
            print()
    ...
    while True:
        try:
            ...
            if num_cars_insured < 1:
                ...
                print(
                    RED
                    + "Data Entry Error - Number of cars insured cannot be less than 1. Please try again."
                    + RESET
                )
                continue
            elif num_cars_insured > 1:
                print(
                    f"{GREEN}You have entered {num_cars_insured} cars to be insured. This qualifies you for a {formatted_extra_car_discount_rate} discount!{RESET}"
                )
                print()
                break
            elif num_cars_insured == 1:
                ...
                add_another_vehicle = input(
                    f"Would you like to add another vehicle to qualify for a {formatted_extra_car_discount_rate} discount? (Y/N): "
                ).upper()
                print()
    ...
    while True:
        ...
        payment_method = input(
            "Enter the payment method (Full, Monthly, or Down Pay): "
        ).title()
